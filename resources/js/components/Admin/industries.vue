          ...
          <div class="col-12 col-sm-12 col-md-8 col-lg-9 col-xl-9">
            <div id="update" class="tabcontent" style="display:block">
              ...
              <div class="container">
                <div class="row">
                  <div class="col-md-12">
                    <div class="new-btn mb-4">
                      ...
                      <router-link :to="{name:'industry-add'}">
                  ...
                  <vue-good-table :columns="columns" :rows="tableData.data">
                    <template slot="table-row" slot-scope="props">
                      <span v-if="props.column.field == 'actions'">
                        <router-link
                          :to="{name:'industry-update', params:{ id: props.row.id, title: props.row.title}}"
                        >
                ...
                <div v-else>No industries created yet</div>
              </div>
              <!-- end -->
            </div>
          </div>
...
export default {
  ...
  methods: {
    async getResults(page = 1) {
      this.loader = true;
      this.tableData = (
        await axios.get("/index.php/api/industries?page=" + page)
      ).data;
    ...
    showDeleteModal(data) {
      ...
      this.modelData = data;
      this.modalText = "Do you really want to delete this Industry";
      this.type = "delete";
    },
    ...
    async UserAction() {
      ...
      axios
        .delete("/index.php/api/industries/" + this.modelData.id)
        .then((response) => {
